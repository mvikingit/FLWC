...
| 2026-07-12 FLWC_B1_CLAIM_EVENT_SYNTHETIC_COMPILER_SKELETON_V1 | ACCEPTED_REMOTE | Accepted as fixture-only B1 claim/event synthetic compiler seam at remote main `96f40bac6de2dcd9f12ac4bbfe8d6c2751a85ae4`; includes A3-derived FLWCAtomicClaimV1 / FLWCAtomicClaimLedgerV1 / FLWCFinancialEventV1 / FLWCFinancialEventTableV1 fixture contracts, deterministic validators, deterministic synthetic compiler builders, and valid/invalid fixture corpus. Model output and raw model payload fields are denied before schema coercion. A3 carry-forward fields `raw_storage_policy`, `retention_policy`, `source_trust_tier`, and `prompt_injection_flags` are required on claim/event artifacts. Source/license/raw-evidence validation carries forward. Campaign artifact is an executable synthetic compiler seam. No source authority mutation, real source ingestion, model/API/runtime/database/trading authority, real claim ledger authority, or real event table authority opened. |
