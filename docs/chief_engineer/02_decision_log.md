...
Non-claim: no entry here opens real source ingestion, vendor API, web scraping, DuckDB seed, runtime service, production, live trading, scanner, order, broker, execution, position sizing, market-data authority, or local LLM truth authority.
